...
export function getAllNodes(ns, startPoint = ns.getHostname()) { // deprecated, newer, faster, better version found above, kept of legacy reasons
  ns.disableLog('scan');
...
export function attemptCrack(ns, target, reqPortsToNuke) {
  const allTheCracks = [
    "BruteSSH.exe",
    "FTPCrack.exe",
    "relaySMTP.exe",
